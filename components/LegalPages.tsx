              ...
              {type === 'terms' ? (
                ...
                <>
                  <section className="space-y-4">
                    ...
                    <p>We collect minimal information required to ensure a precise learning experience. This includes your study progress, personalized calibration data, and assessment scores, which are securely stored in our Firestore database to ensure persistence across all your devices.</p>
                  </section>
